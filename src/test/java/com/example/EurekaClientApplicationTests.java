...
public class EurekaClientApplicationTests {
    ...
    public static void startEureka() {
        eurekaServer = SpringApplication.run(EurekaServer.class, "--server.port=8761", "--eureka.instance.leaseRenewalIntervalInSeconds=1");
    }
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        this.port = 8766;
        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/client/eureka-client", String.class);
